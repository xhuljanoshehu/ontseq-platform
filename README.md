...
| Zielpanel | Aus den Laborquellen abgeleitetes, gepuffertes GRCh38-Panel mit 111 eindeutig benannten Zielintervallen unter `configs/panels/`; die Zahl ist keine unabhängig validierte Genzahl; Status `derived_unconfirmed`, siehe [`docs/PANEL_PROVENANCE.md`](docs/PANEL_PROVENANCE.md) |
