...
Fresh settings default to `~/.local/share/ontseq/resources-v0.8.2`, with the suffix derived
...
`~/.local/share/ontseq/runtime-v0.8.2-<unique-id>` directory, relocates the base runtime,
